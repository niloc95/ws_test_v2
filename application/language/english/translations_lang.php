...
$lang['about_app'] = 'About @webSchedulr';
...
$lang['about_app_info'] = '@webSchedulr is a versatile SaaS solution designed for both on-premise and cloud-based deployments, enabling seamless appointment booking for your customers.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using @webSchedulr you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = '@webSchedulr is licensed under the GPLv3 license. By using the code of @webSchedulr in any way you are agreeing to the terms described in the following url:';
...
$lang['you_need_to_login'] = 'Please login to view your calender';
...
$lang['ws_update_success'] = '@webSchedulr has been successfully updated.';
...
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the @webSchedulr API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API enable you to interact with all the @webSchedulr data via the HTTP protocol and the available API endpoints and create your own integrations.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'This integration enables you to connect to an existing LDAP server and automatically import users into @webSchedulr and let them SSO with their directory password (username must match).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
