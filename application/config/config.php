...
$config['base_url'] = isset($_ENV['BASE_URL']) ? $_ENV['BASE_URL'] : ''; // Use $_ENV
...
|
*/
$default_language = isset($_ENV['APP_LANGUAGE']) ? $_ENV['APP_LANGUAGE'] : 'english'; // Use $_ENV
...
|
*/
$config['encryption_key'] = isset($_ENV['ENCRYPTION_KEY']) ? $_ENV['ENCRYPTION_KEY'] : ''; // Use $_ENV
