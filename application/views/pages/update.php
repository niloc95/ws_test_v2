...
<head>
    ...
    <title>Update | @webSchedulr</title>
...
<header>
    <div class="container">
        <h1 class="page-title">@webSchedulr Update</h1>
    </div>
</header>
        ...
        <div class="col">
            <?php if (vars('success')): ?>
                <div class="jumbotron">
                    ...
                    <hr class="my-4">
                    <p>
                        You can now use the latest @webSchedulr version.
                    </p>
...
<footer>
    Powered by <a href="https://webschedulr.co.za">@webSchedulr</a>
</footer>
