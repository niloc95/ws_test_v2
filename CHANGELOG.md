...
- #664: @webSchedulr v1.3.2 allows sensitive information disclosure (username and password hash).
...
- #176: Add Docker container for @webSchedulr development.
...
- #21: Fix @webSchedulr installation problems with AJAX requests.
- #66: Trouble with breaks for providers.

## [1.0.0] - 2014-01-19 

First @webSchedulr release ever! ☺
