...
> This page contains information about the CLI support of @webSchedulr.

### Introduction

Starting from v1.4.0 @webSchedulr has introduced CLI support, providing a set of useful utilities to use with your installation. 
...
This command will perform a CLI installation of @webSchedulr. 
